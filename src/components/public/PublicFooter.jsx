      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 py-20">
          ...
          <div className="space-y-8">
            <Link
              to="/"
              className="inline-block group transition-transform hover:scale-[1.02]  bg-white rounded-xl"
            >
              <img
                src={logo}
                width={150}
            ...
            <p className="text-[12px] font-medium text-gray-400 leading-relaxed uppercase tracking-tight">
              Tripzybee is a premier travel-tech ecosystem delivering curated
              2026 group expeditions and solo adventures across India. We focus
              on <span className="text-amber-500">transparency</span>,{" "}
              <span className="text-amber-500">safety</span>, and digital-first
              logistics.
            </p>
          ...
          <div>
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4 p-4 rounded-2xl bg-white/5 border border-white/5 group hover:border-amber-500/30 transition-colors">
                ...
                <div>
                  <p className="text-[10px] font-black text-gray-200 uppercase tracking-widest leading-none mb-2">
                    Operational Hours
                  </p>
                  <p className="text-[11px] font-bold text-gray-500 uppercase tracking-tighter italic">
                    Mon - Sat: 09:00 - 20:00
                  </p>
                </div>
              </div>
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4 group">
                ...
                <p className="text-[11px] font-bold text-gray-400 leading-relaxed uppercase tracking-tighter italic group-hover:text-gray-200 transition-colors">
                  Lakshmi Tarang Society, RMV 2nd Stage,
                  <br />
              ...
              <div className="flex items-center gap-4 group">
                ...
                <a
                  href="tel:+919036751234"
                  className="text-[13px] font-black text-gray-300 hover:text-amber-500 tracking-tighter"
                >
                  +91 90367 51234
                </a>
              </div>
