...
const UnifiedHeader = () => {
  ...
  return (
    <>
      <header className="bg-white border-b border-slate-100 fixed top-0 w-full z-[100] h-16">
        <div className="max-w-7xl mx-auto px-6 h-full flex items-center justify-between">
          
          {/* LOGO */}
          <div className="flex items-center gap-10">
            <Link to="/" className="flex items-center gap-2 group">
              <div className="bg-yellow-400 p-1.5 rounded-lg group-hover:bg-black transition-all">
                <Plane className="h-5 w-5 text-black group-hover:text-yellow-400" />
              </div>
