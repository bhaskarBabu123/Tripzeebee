          ...
          <div className="max-w-4xl">
            <div className="flex items-center gap-3 mb-8">
              ...
              <span className="text-[11px] font-bold uppercase tracking-[0.4em] text-yellow-400/80">
                Tripzy<span className="text-white">Bee</span> • India's Group
                Trip Experts
              </span>
            </div>
            ...
            <h1 className="text-[14vw] lg:text-[10rem] font-black leading-[0.85] tracking-tighter text-white uppercase italic">
              Tripzy<span className="text-yellow-400 not-italic">Bee</span>
            </h1>
            ...
            <div className="flex flex-col lg:flex-row lg:items-center gap-8 lg:gap-16 mt-4">
              <h2 className="text-4xl lg:text-7xl font-light tracking-tighter text-white/90">
                Solo Friendly <br />
                <span className="font-black italic text-yellow-400 uppercase">
                  Group Trips.
                </span>
              </h2>
              ...
              <div className="max-w-xs space-y-6">
                <p className="text-xs lg:text-[15px] font-medium leading-relaxed text-white/60 border-l-2 border-amber-500 pl-8">
                  ...
                  for 2026. We engineer <strong>solo travel packages</strong>,{" "}
                  <strong>Ladakh bike trips</strong>, and{" "}
                  <strong>backpacking expeditions</strong> across the Himalayas
                  and South India.
                </p>
                <Link
                  to="/about"
                  className="flex items-center gap-4 pl-6 group cursor-pointer"
                >
