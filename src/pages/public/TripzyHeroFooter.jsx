        ...
        <div className="flex whitespace-nowrap animate-marquee">
          {[...Array(6)].map((_, i) => (
            <div key={i} className="flex items-center gap-12 px-6">
              <span
                className="text-[60px] lg:text-[80px] font-black text-transparent opacity-20 uppercase tracking-tighter"
                style={{
                  WebkitTextStrokeColor: "#fff !important",
                  WebkitTextStrokeWidth: "1px !important",
                }}
              >
                TripzyBee
              </span>
